...
function runOnce()
{
    ...
    python testRunner.py -dockerRunnerArg "DOCKERMACHINE:eth0;myengine0,myengine1" -outputDir /tmp/jopamaResults -numClusters 2 -clusterSize 1 -numTP 1 -numTC 1 -firstComp 100 -numComp 10000 -compsInTra 10 -outForTC 100 -outForTP 20 -duration 180
    local retVal=$?
