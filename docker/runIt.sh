...
function runOnce()
{
    ...
    python testRunner.py -ips 127.0.0.1 -numClusters 1 -clusterSize 1 -numTP 1 -numTC 1 -firstComp 100 -numComp 1000 -compsInTra 10 -outForTC 100 -outForTP 10 -duration 120
    local retVal=$?
